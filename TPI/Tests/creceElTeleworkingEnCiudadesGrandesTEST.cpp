...
//TESTS DEL GRUPO
TEST(creceElTeleworkingEnCiudadesGrandesTEST, noHayTrabajadoresEnHogaresValidos) {
...
//                                                                   v
    ...
    eph_h t2h = {{22114, 2020,   3,  319611, 629088, 3,  41, 1,  1,  3,  1,  2}, // Esta no: Sin lugar para trabajar
                 {31117, 2020,   3,  332870, 642475, 3,  40, 1,  1,  6,  6,  2}, // Esta no: Sin lugar para trabajar
                 {22866, 2020,   3,  317157, 627217, 2,  42, 1,  3,  2,  2,  2}, // Esta no: Sin lugar para trabajar
                 {20957, 2020,   3,  313965, 623297, 1,  43, 0,  1,  3,  1,  2}};// Esta no: Sin lugar para trabajar

    eph_i t2i = {{20957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000,  1}, //Este individuo no trabaja
                 {20957, 2020,   2,  1,  3,  2,  82, 0,  0,  25000,  1}, //Este individuo no trabaja
                 {22866, 2020,   1,  0,  3,  1,  31, 0,  3,  59000,  1}, //Este individuo no trabaja
                 {22866, 2020,   2,  1,  3,  2,  28, 0,  3,  0,      6}, //Este individuo no trabaja
                 {31117, 2020,   3,  0,  3,  2,  46, 0,  3,  17000,  1}, //Este individuo no trabaja
                 {31117, 2020,   4,  0,  3,  1,  20, 0,  3,  5000,   6}, //Este individuo no trabaja
                 {31117, 2020,   5,  0,  3,  2,  15, 0,  0,  5000,   6}, //Este individuo no trabaja
                 {22114, 2020,   1,  0,  3,  1,  18, 0,  0,  20000,  1}}; //Este individuo no trabaja
