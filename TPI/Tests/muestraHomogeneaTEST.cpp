...
TEST(muestraHomogeneaTEST, variasDe3UnaLarga) {
    vector<hogar> esperado = {{543, 2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},
...
TEST(muestraHomogeneaTEST, todaUnaSolucion) {
    ...
    eph_i ti = {{1009, 2018, 1, 1, 1, 1, 36, 1, 3, 1, 1}, // 1
                {210, 2018, 1, 1, 1, 1, 36, 1, 3, 1, 1}, // 2
                {210, 2018, 2, 1, 1, 1, 36, 1, 3, 1, 1},
                {4377, 2018, 1, 1, 1, 1, 36, 1, 3, 1, 1}, // 3
                {4377, 2018, 3, 1, 1, 1, 36, 1, 3, 2, 1},
                {960, 2018, 3, 1, 1, 2, 51, 1, 4, 1, 1}, //4
                {960, 2018, 2, 1, 1, 2, 51, 1, 4, 1, 1},
                {960, 2018, 1, 1, 1, 2, 51, 1, 4, 2, 1},
                {340, 2018, 1, 1, 1, 1, 36, 1, 3, -1, 1}, // 0
                {340, 2018, 3, 1, 1, 1, 36, 1, 3, -1, 1}};
...
TEST(muestraHomogeneaTEST, sinSueldoReportados) {
    ...
    eph_i ti = {{340, 2018, 1, 1, 1, 1, 36, 1, 3, -1, 1},
                {340, 2018, 3, 1, 1, 1, 36, 1, 3, -1, 1},
                {1009, 2018, 1, 1, 1, 1, 36, 1, 3, -1, 1},
                {210, 2018, 1, 1, 1, 1, 36, 1, 3, -1, 1},
                {210, 2018, 2, 1, 1, 1, 36, 1, 3, -1, 1},
                {4377, 2018, 1, 1, 1, 1, 36, 1, 3, -1, 1},
                {4377, 2018, 3, 1, 1, 1, 36, 1, 3, -1, 1},
                {960, 2018, 3, 1, 1, 2, 51, 1, 4, -1, 1},
                {960, 2018, 2, 1, 1, 2, 51, 1, 4, -1, 1},
                {960, 2018, 1, 1, 1, 2, 51, 1, 4, -1, 1}};
...
TEST(muestraHomogeneaTEST, ningunaSolucion) {
    vector <hogar> esperado = {};
