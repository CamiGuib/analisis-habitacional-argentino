...
//TESTS DEL GRUPO
TEST(esEncuestaValidaTEST, archivoInexistente) {
    eph_h th;
    eph_i ti;
    leerEncuesta ( "archivoInexistente", th, ti );

    EXPECT_EQ( false, esEncuestaValida(th, ti) );
}

TEST(esEncuestaValidaTEST, hogarSinIndividuo) {
    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  41, 0,  1,  3,  1,  2},
                {22866, 2020,   1,  317157, 627217, 2,  42, 1,  1,  2,  5,  2},
                {20957, 2020,   3,  313965, 623297, 1,  43, 0,  1,  3,  1,  2}};
    eph_i ti = {{20957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000,  10},
...
TEST(esEncuestaValidaTEST, hogarConMasDe21Individuos) {
    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  41, 0,  1,  3,  1,  2}};
    eph_i ti;
...
TEST(esEncuestaValidaTEST, hogarConRegionInvalida) {
    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  71, 0,  1,  3,  1,  2}};
    eph_i ti = {{22114, 2020,   1,  0,  3,  1,  18, 0,  0,  20000,  10}};
    EXPECT_FALSE(esEncuestaValida(th, ti));
}

TEST(esEncuestaValidaTEST, hogarConMasDormitoriosQueHabitaciones) {
    //                                                cantidad de dormitorios
    //                                        cantidad de habitaciones  |
    //                                                              |   |
    //                                                              v   v
...
TEST(esEncuestaValidaTEST, encuesta2020) {
    eph_h th;
    eph_i ti;
    leerEncuesta ( "eph_3c_2020_100", th, ti );
